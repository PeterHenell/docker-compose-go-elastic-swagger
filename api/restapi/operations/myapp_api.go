...
// NewMyappAPI creates a new Myapp instance
func NewMyappAPI(spec *loads.Document) *MyappAPI {
	return &MyappAPI{
...
/*MyappAPI This is a sample server Petstore server.  You can find out more about     Swagger at [http://swagger.io](http://swagger.io) or on [irc.freenode.net, #swagger](http://swagger.io/irc/).      For this sample, you can use the api key `special-key` to test the authorization     filters. */
type MyappAPI struct {
	spec            *loads.Document
...
func (o *MyappAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *MyappAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *MyappAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *MyappAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *MyappAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *MyappAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *MyappAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the MyappAPI
func (o *MyappAPI) Validate() error {
...
func (o *MyappAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *MyappAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
...
func (o *MyappAPI) Authorizer() runtime.Authorizer {
...
func (o *MyappAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
func (o *MyappAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *MyappAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the myapp API
func (o *MyappAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *MyappAPI) initHandlerCache() {
...
func (o *MyappAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *MyappAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *MyappAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
