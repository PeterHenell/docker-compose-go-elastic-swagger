...
import (
	...
	"github.com/PeterHenell/docker-compose-go-elastic-swagger/api/generated/restapi/operations/store"
	"github.com/PeterHenell/docker-compose-go-elastic-swagger/api/generated/restapi/operations/user"
	"github.com/PeterHenell/docker-compose-go-elastic-swagger/api/actions"
)

//go:generate swagger generate server --target ../generated --name myapp --spec ../../../../../../../local/petstore.yaml
...
func configureAPI(api *operations.MyappAPI) http.Handler {
	...
	api.PetAddPetHandler = actions.AddPetHandler // from actions/pet.go
	...
	api.PetDeletePetHandler = actions.DeletePetHandler
	...
	api.PetFindPetsByStatusHandler = actions.FindPetsByStatusHandler

	api.PetFindPetsByTagsHandler = actions.FindPetsByTagsHandler

	api.StoreGetInventoryHandler = store.GetInventoryHandlerFunc(func(params store.GetInventoryParams, principal interface{}) middleware.Responder {
	...
	api.PetGetPetByIDHandler = actions.GetPetByIDHandler
	...
	api.PetUpdatePetHandler = actions.UpdatePetHandler

	api.PetUpdatePetWithFormHandler = actions.UpdatePetWithFormHandler
	...
	api.PetUploadFileHandler = actions.UploadFileHandler
